...
package com.idas.app.javasurf.src.main.java.org.javasurf.base;
...
public interface ISURFfactory {
     ...
     *
     * @param interest_points ArrayList of Interest Point on which the descriptor will
     ...
     *
     * @param img PImage that is converted into Integral Image before it's
     *            assigned to SURF.
     */
